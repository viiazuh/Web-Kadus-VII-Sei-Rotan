...
export default function AboutSection({ fullPage }) { // Tambahkan prop fullPage
  return (
    // Jika fullPage, beri padding atas yang lebih besar (pt-28)
    <section id="about" className={`py-20 bg-white/40 backdrop-blur-sm ${fullPage ? 'pt-28 min-h-screen' : ''}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          {/* Card Visi Misi dengan Glass Effect */}
          <div className="bg-white/80 backdrop-blur-md p-10 rounded-3xl shadow-lg hover:shadow-xl transition text-center border-t-8 border-blue-600 relative overflow-hidden">
