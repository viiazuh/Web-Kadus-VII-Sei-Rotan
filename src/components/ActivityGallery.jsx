...
import { MapPin, Calendar, CameraOff } from 'lucide-react';

export default function ActivityGallery() {
  // DATA KEGIATAN KOSONG
  // Nanti kalau ada kegiatan, Bapak tinggal isi di dalam kurung siku []
  // Contoh format: { id: 1, title: "...", date: "...", description: "...", location: "...", image: "/foto.jpg" },
  const activities = [];
  ...
  return (
    <section id="gallery" className="py-20 bg-slate-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* LOGIKA TAMPILAN: JIKA KOSONG vs JIKA ADA ISI */}
        {activities.length === 0 ? (
            ...
            <div className="text-center py-16 bg-white rounded-3xl border-2 border-dashed border-slate-200">
                ...
                <p className="text-slate-500 mt-2 max-w-md mx-auto">
                    Saat ini belum ada foto kegiatan yang diunggah. Dokumentasi kegiatan terbaru akan segera ditampilkan di sini.
                </p>
            </div>

        ) : (

            // --- TAMPILAN JIKA ADA DATA (LIST KEGIATAN) ---
